...
const SUGGESTED: SuggestedLink[] = [
  { href: "/", labelKey: "notFound.suggested.0.label", labelFallback: "Home", descriptionKey: "notFound.suggested.0.description", descriptionFallback: "Start here", icon: Home },
  { href: "/docs", labelKey: "notFound.suggested.1.label", labelFallback: "Docs", descriptionKey: "notFound.suggested.1.description", descriptionFallback: "How it works", icon: BookOpen },
  { href: "/benchmarks", labelKey: "notFound.suggested.2.label", labelFallback: "Benchmarks", descriptionKey: "notFound.suggested.2.description", descriptionFallback: "Verifiable benchmarks", icon: Gauge },
  { href: "/pricing", labelKey: "notFound.suggested.3.label", labelFallback: "Pricing", descriptionKey: "notFound.suggested.3.description", descriptionFallback: "$0 forever", icon: CreditCard },
  { href: "/blog", labelKey: "notFound.suggested.4.label", labelFallback: "Blog", descriptionKey: "notFound.suggested.4.description", descriptionFallback: "Latest writing", icon: Newspaper },
];

// Global 404 UI — rendered by the nearest not-found boundary when
// notFound() is thrown (the catch-all route delegates here).
