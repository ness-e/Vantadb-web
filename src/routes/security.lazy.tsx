      ...
      <main>
        <section className="nb-section">
          <div className="nb-inner">
            <h2 className="security-heading">CORE PRINCIPLES</h2>

            <div className="nb-grid nb-grid--cols-3 security-grid">
              <div className="nb-cell">
                <div className="security-cell-label">NO TELEMETRY</div>
              ...
              <div className="nb-cell">
                <div className="security-cell-label">AES-256-GCM ENCRYPTION</div>
                <p className="text-sm text-muted leading-relaxed m-0 mt-4">
              ...
              <div className="nb-cell">
                <div className="security-cell-label">MEMORY SAFETY</div>
                <p className="text-sm text-muted leading-relaxed m-0 mt-4">
          ...
          <div className="nb-inner">
            <div className="nb-block-amber">
              <div className="flex items-center justify-between gap-4 flex-wrap">
                <div>
                  <h2 className="font-display text-2xl font-extrabold security-block-heading">
                    Built on Rust. Safe by default.
                  </h2>
                  <p className="text-sm security-block-text">Install VantaDB in one command.</p>
                </div>
