...
export const Route = createLazyRoute("/about/roadmap")({
    ...
    <div className="engine-page">
      ...
      <main className="engine-main">
        <nav aria-label="Breadcrumb" style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", color: "var(--muted)", marginBottom: "0", padding: "0 clamp(1.5rem, 5vw, 4rem)", marginTop: "1rem" }}>
          ...
          <span style={{ color: "var(--foreground)" }}>Roadmap</span>
        </nav>
          ...
          <div style={{ marginTop: "3rem", display: "grid", gap: "2rem" }}>
            <div style={{ borderLeft: "2px solid var(--amber)", paddingLeft: "1.5rem" }}>
              ...
              <p style={{ color: "var(--steel)", margin: 0, lineHeight: "1.6" }}>
                HNSW Vector Search, LSM-Tree WAL durability, BM25 text search, Reciprocal Rank
                Fusion (RRF), Python PyO3 SDK, and HTTP/MCP Servers.
              </p>
            </div>
            ...
            <div style={{ borderLeft: "2px solid var(--border)", paddingLeft: "1.5rem" }}>
              ...
              <p style={{ color: "var(--steel)", margin: 0, lineHeight: "1.6" }}>
                Deprecating unmaintained dependencies, increasing test coverage, unifying
                documentation, and preparing the web presence.
              </p>
            </div>
