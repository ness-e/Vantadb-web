        ...
        <div className="nb-inner">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "var(--border-visible)", marginTop: "var(--space-xl)" }}>
            <div className="nb-cell" style={{ padding: "var(--space-xl)" }}>
              <span className="nb-label" style={{ marginBottom: "var(--space-md)" }}>Code search is still text-only</span>
            ...
            <div className="nb-cell" style={{ padding: "var(--space-xl)", borderLeft: "2px solid var(--amber)", background: "var(--surface-alt)" }}>
              <span className="nb-label nb-label--amber" style={{ marginBottom: "var(--space-md)" }}>Semantic, embedded</span>
              <ul className="nb-list">
                {BENEFITS.map((s) => (
      ...
      <section className="nb-section nb-bg-cross--faint">
        <div className="nb-inner">
          ...
          <div className="nb-grid nb-grid--cols-3">
            {USE_CASES.map((uc) => (
              <div key={uc.num} className="nb-cell" style={{ padding: "var(--space-xl)" }}>
                <span className="nb-label nb-label--amber" style={{ marginBottom: "var(--space-2xs)" }}>{uc.num}</span>
          ...
          <div className="nb-card" style={{ marginTop: "1px", background: "var(--surface)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "var(--space-lg)", alignItems: "start" }}>
              <span className="nb-label" style={{ marginBottom: 0 }}>HOW IT WORKS</span>
              <p style={{ fontFamily: "var(--font-sans)", fontSize: "var(--text-code)", color: "var(--muted)", lineHeight: 1.7, margin: 0 }}>
      ...
      <section className="nb-section">
        <div className="nb-inner">
          <div className="nb-block-amber" style={{ textAlign: "center" }}>
            <span className="nb-label" style={{ color: "var(--text-on-amber)" }}>BUILD IDE TOOLS</span>
