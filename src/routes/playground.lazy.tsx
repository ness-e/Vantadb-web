...
import { NbPill } from "@/components/nb/NbPill";
...
const FAKE_RESULTS: Record<string, { id: string; score: number; text: string }[]> = {
  "search similar to 'quantum computing'": [
    { id: "doc_042", score: 0.94, text: "Quantum circuit optimization using variational algorithms" },
    ...
    { id: "doc_056", score: 0.76, text: "Entanglement distillation for distributed quantum computing" },
    { id: "doc_331", score: 0.72, text: "Noisy intermediate-scale quantum (NISQ) device benchmarking" },
  ],
  "hybrid search 'machine learning papers 2024'": [
    { id: "doc_189", score: 0.96, text: "LoRA: Low-Rank Adaptation of Large Language Models" },
    { id: "doc_044", score: 0.91, text: "Scalable diffusion models for high-resolution image synthesis" },
  ...
  "knn 5 nearest 'transformer architecture'": [
    ...
    { id: "doc_155", score: 0.82, text: "TransformerXL: Attentive Language Models Beyond a Fixed-Length Context" },
    { id: "doc_290", score: 0.77, text: "Efficient Transformers: A Survey of Efficient Attention Mechanisms" },
  ],
};
...
function PlaygroundPage() {
  ...
  const [results, setResults] = useState<{ id: string; score: number; text: string }[] | null>(null);
  ...
  function runQuery() {
    ...
    setResults(null);
    setTimeout(() => {
      const hit = FAKE_RESULTS[input.trim()] ?? FAKE_RESULTS[Object.keys(FAKE_RESULTS)[0] as keyof typeof FAKE_RESULTS];
      setResults(hit ?? []);
      setSimulating(false);
    }, 800);
  }
  ...
  return (
    <div className="nb-page">
        ...
        <div className="nb-inner">
          ...
          >
            ...
            >
              ...
              <span style={{ ...CMD_LINE_STYLE, color: "var(--steel)", marginLeft: "auto", fontSize: "0.6rem" }}>
                vantadb@playground
              </span>
            </div>
            ...
            <div style={{ padding: "var(--space-md)" }}>
              ...
              >
                {simulating && (
                  <span style={{ ...CMD_LINE_STYLE, color: "var(--amber)" }}>
                    &gt; simulating query... <NbPill>HNSW</NbPill> <NbPill>BM25</NbPill> <NbPill>Fuse</NbPill>
                  </span>
                )}

                {results && !simulating && (
                  <div>
                    <span style={{ ...CMD_LINE_STYLE, color: "var(--steel)", display: "block", marginBottom: "var(--space-sm)" }}>
                    ...
                    {results.map((r) => (
                      ...
                      >
                        ...
                        <span style={{ ...CMD_LINE_STYLE, color: "var(--steel)", fontSize: "0.6rem", width: 30, textAlign: "right" }}>
                          {r.score.toFixed(2)}
                        </span>
                      </div>
                    ))}
      ...
      <section className="nb-section nb-bg-cross--faint">
        <div className="nb-inner">
          <span className="nb-label nb-label--amber">03 / 04 — Quick Start</span>
      ...
      <section className="nb-section">
        <div className="nb-inner">
          ...
          >
            <span className="nb-label nb-label--amber">Get Started</span>
            <div
              style={{
                fontFamily: "var(--font-mono)",
                fontSize: "var(--text-code)",
