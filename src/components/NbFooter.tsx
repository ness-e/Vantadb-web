...
export const NbFooter = memo(function NbFooter() {
  return (
    <NbSection variant="dark" ariaLabel="Site footer" as="footer" className="swiss-footer">
      <div className="footer-frame">
        <div className="footer-grid">
          <div className="footer-col footer-col--brand">
            <VantaDBLogo variant="full" size="sm" />
            <span className="nb-mono-label nb-mono-label--muted footer-tagline">
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-left">
          <span className="footer-copyright">&copy; {new Date().getFullYear()} VantaDB</span>
        </div>
