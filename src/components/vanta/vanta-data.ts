...
export const PRICING_PLANS = [
  ...
  },
  {
    ...
    tagColor: "neon",
    highlight: true,
    description: "For teams shipping local-first AI products in production.",
    features: [
      "Everything in Community",
      "Priority bug fixes & SLA (48h)",
      "Private Discord channel",
      "Heavy Certification workflow access",
      "Performance tuning guidance",
      "Pre-release builds & changelog briefings",
      "Up to 10 dev seats",
    ],
    cta: "Start Team Trial",
    ctaLink: VANTA.discord,
  },
  {
    name: "Enterprise",
    price: "Custom",
