  ...
  return (
    <>
      <nav className={`nc-nav${scrolled ? " nc-nav--scrolled" : ""}`} aria-label="Main navigation">
        ...
        <button
          className={`nc-nav-toggle${drawerOpen ? " nc-nav-toggle--open" : ""}`}
          onClick={() => setDrawerOpen((v) => !v)}
          aria-label={drawerOpen ? "Close menu" : "Open menu"}
          aria-expanded={drawerOpen}
        >
          <span className="nc-toggle-bar" />
          <span className="nc-toggle-bar" />
          <span className="nc-toggle-bar" />
        </button>
      </nav>
      ...
      <NavDrawer
          ...
          (() => {
            ...
            return all.map((item, idx) => (
              ...
              >
                ...
                {isActive(item.path) && (
                  <span className="nc-drawer-active-mark" aria-hidden="true">■</span>
                )}
              </Link>
            ));
          })()
        ...
        footer={
          <a href="https://github.com/ness-e/Vantadb" target="_blank" rel="noreferrer" className="nc-drawer-cta">
